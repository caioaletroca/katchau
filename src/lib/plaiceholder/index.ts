 ...
 *
 * This file was copied from plaiceholder npm package, since they only made available ESM import system
 * Placing down here was easier than trying to make it work with NextJS and ts-node for prisma
 *
 * https://github.com/joe-bell/plaiceholder
 */

// @ts-nocheck
import sharp, { OutputInfo, type Metadata, type Sharp } from 'sharp';
