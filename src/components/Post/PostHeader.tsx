...
import api from "@/api";
import { Avatar, IconButton, List, ListItemButton, ListItemIcon, ListItemText, Typography } from "@mui/material";
...
export default function PostHeader({ user, post_id, onDelete }: PostHeaderProps) {
	const intl = useIntl();
